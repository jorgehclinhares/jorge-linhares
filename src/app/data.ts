...
export const Experience = [
  {
    ...
    "item": [
      {
        "title": "Desenvolvedor Appcelerator",
        "description": [
          "Desenvolvimento de aplicações híbridas Android e IOs"
        ]
      },
      {
        "title": "Desenvolvedor Web",
        "description": [
          "Desenvolvimento de aplicações web com Angular 2x/4x",
          "Desenvolvimento de aplicações web com PHP e Slim Framework",
          "Desenvolvimento de REST APIs com NodeJs/Express",
          "Desenvolvimento de interfaces de usuário para aplicações web e mobile",
          "Análise de experiência de usuário para aplicações web e mobile"
        ]
      }
    ]
  },
    ...
    "item": [
      {
        "title": "Desenvolvedor Web",
        "description": [
          "Desenvolvimento de websites com PHP"
        ]
      }
    ]
  }
